    ...
    <a-dropdown :trigger="['click']" v-if="userStore.isLoggedIn">
      ...
      <template #overlay>
        <a-menu>
          ...
          <a-menu-item key="account" @click="openProfile">
            <template #icon><CircleUser :size="16" /></template>
...
import { BookOpen, Sun, Moon, LogOut, Settings, Terminal, CircleUser } from 'lucide-vue-next'
