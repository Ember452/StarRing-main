    ...
    <div class="status-bar-content">
      ...
      <div class="status-right">
        ...
        <div class="header-actions">
          <a-tooltip :title="settingsEntryLabel">
            <button
              type="button"
              class="header-action-button"
              :aria-label="settingsEntryLabel"
              @click="openSettings"
            >
              <Settings class="icon" />
            </button>
...
// 设置入口文案：管理员显示"系统设置"，普通用户显示"账户设置"
const settingsEntryLabel = computed(() => (userStore.isAdmin ? '系统设置' : '账户设置'))
