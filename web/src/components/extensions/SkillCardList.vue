...
const rememberRemoteSource = (source) => {
  ...
  localStorage.setItem('STARRING_remote_repo_history', JSON.stringify(history))
}
...
const loadHistory = () => {
  try {
    const raw = localStorage.getItem('STARRING_remote_repo_history')
    if (raw) {
...
const deleteHistoryItem = (item) => {
  ...
  localStorage.setItem('STARRING_remote_repo_history', JSON.stringify(repoHistory.value))
}

const clearAllHistory = () => {
  repoHistory.value = []
  localStorage.removeItem('STARRING_remote_repo_history')
