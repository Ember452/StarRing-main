import { apiGet, apiPost, apiPut, apiDelete, apiAdminGet, apiAdminPost, apiAdminDelete, apiRequest } from './base'
...
export const documentApi = {
  ...
  moveDocument: async (kbId, docId, newParentId) => {
    return apiPut(`/api/knowledge/databases/${kbId}/documents/${docId}/move`, {
