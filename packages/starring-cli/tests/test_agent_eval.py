...
from starring_cli.agent_eval import AgentEvalError, AgentEvalOptions, extract_query, run_langfuse_agent_experiment
...
def test_run_langfuse_agent_experiment_uses_remote_api_key(tmp_path):
    ...
    run_langfuse_agent_experiment(
        ...
        client_factory=FakeStarRingClient,
    )
    ...
    call = FakeStarRingClient.calls[0]
