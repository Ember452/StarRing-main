...
const GITHUB = 'https://github.com/Ember452/StarRing'
  ...
  <div class="yx-home">
    ...
    <section class="yx-hero">
      ...
      <div class="yx-container yx-hero__inner">
        ...
        <h1 class="yx-hero__title">StarRing <span class="yx-accent">StarRing</span></h1>
    ...
    <section class="yx-section">
      <div class="yx-container">
        <header v-reveal class="yx-head">
          ...
          <p class="yx-head__sub">StarRing 内置一套完整的 Harness——沙盒、技能、工具、子智能体与中间件，让智能体真正动手完成任务。</p>
        </header>
        <div class="yx-bento">
          <article
    ...
    <section class="yx-section yx-section--soft">
      <div class="yx-container yx-center">
        ...
        <a v-reveal :href="GITHUB + '/graphs/contributors'" target="_blank" rel="noreferrer" class="yx-contrib">
          <img src="https://contrib.rocks/image?repo=Ember452/StarRing&max=60&columns=12" alt="StarRing 贡献者头像墙" loading="lazy" />
        </a>
