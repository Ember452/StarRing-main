...
from starring.models.chat import select_model
from starring.models.embed import OtherEmbedding
from starring.models.rerank import DashscopeReranker, OpenAIReranker
from starring.models.providers.cache import ModelInfo
from starring.models.providers.service import (
    resolve_api_key,
    ensure_builtin_model_providers_in_db,
    get_model_provider_by_id,
)
from starring.storage.postgres.manager import pg_manager
from starring.storage.postgres.models_business import ModelProvider
...
async def test_provider_db_chat_model_connectivity(monkeypatch: pytest.MonkeyPatch):
    ...
    monkeypatch.setattr("starring.models.chat.model_cache.get_model_info", get_model_info)
    monkeypatch.setattr("starring.agents.models.model_cache.get_model_info", get_model_info)
...
async def test_provider_db_rerank_model_connectivity():
    ...
    scores = await reranker.acompute_score(("starring knowledge base", ["starring is a RAG platform.", "Unrelated text."]))
