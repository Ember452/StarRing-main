...
def _get_provider():
    from starring.agents.backends import get_sandbox_provider
...
async def test_viewer_tree_root_does_not_require_sandbox_listing(test_client, standard_user, monkeypatch):
    ...
    service_module = importlib.import_module("starring.services.viewer_filesystem_service")
...
async def test_delete_viewer_file_rejects_user_data_root_without_removing(monkeypatch):
    from starring.services import viewer_filesystem_service as service_module
