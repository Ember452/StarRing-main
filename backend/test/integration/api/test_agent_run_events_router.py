...
import asyncpg
import pytest
from starring.services.run_queue_service import append_run_stream_event, get_redis_client

pytestmark = [pytest.mark.asyncio, pytest.mark.integration]


def _postgres_dsn() -> str:
    return os.getenv("POSTGRES_URL", "postgresql+asyncpg://postgres:postgres@postgres:5432/starring").replace(
        "+asyncpg", ""
    )
