...
nlp.py / general.py 只依赖 re 和标准库，用 sys.modules 占位绕过 starring 包的
...
_STUB_NAMES = [
    "starring",
    "starring.knowledge",
    "starring.knowledge.chunking",
    "starring.knowledge.chunking.ragflow_like",
    "starring.knowledge.chunking.ragflow_like.parsers",
    "starring.knowledge.chunking.ragflow_like.nlp",
    "starring.knowledge.chunking.ragflow_like.parsers.general",
]
...
def _isolated_modules():
    ...
    _nlp = _load(
        "starring.knowledge.chunking.ragflow_like.nlp",
        "starring/knowledge/chunking/ragflow_like/nlp.py",
    )
    sys.modules["starring.knowledge.chunking.ragflow_like"].nlp = _nlp  # type: ignore[attr-defined]

    _general = _load(
        "starring.knowledge.chunking.ragflow_like.parsers.general",
        "starring/knowledge/chunking/ragflow_like/parsers/general.py",
    )
