...
from starring.agents.backends.sandbox import paths as workspace_paths
from starring.services import workspace_service as svc
...
async def test_read_workspace_file_content_returns_pdf_preview_for_office_file(
    ...
    assert result.headers["x-starring-preview-type"] == "pdf"
