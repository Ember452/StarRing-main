...
from starring.agents.backends.sandbox import paths as sandbox_paths
from starring.services import viewer_filesystem_service as svc
from starring.services import workspace_service
...
async def test_read_viewer_workspace_office_file_returns_pdf_preview(
    ...
    assert response.headers["x-starring-preview-type"] == "pdf"
