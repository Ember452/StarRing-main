...
from starring.services import chat_service as svc
...
@pytest.mark.asyncio
async def test_stream_agent_chat_maps_raw_protocol_events_to_STARRING_stream_events(monkeypatch: pytest.MonkeyPatch):
    class FakeGraph:
