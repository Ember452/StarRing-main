...
from starring.knowledge.implementations.notion import NOTION_DEFAULT_VERSION, NotionAPIError, NotionKB
...
async def test_notion_kb_aquery_maps_pages(monkeypatch, notion_kb):
    monkeypatch.setattr("starring.knowledge.implementations.notion._NotionClient", _FakeNotionClient)
...
async def test_notion_open_file_content_rejects_unknown_parent(monkeypatch, notion_kb):
    monkeypatch.setattr("starring.knowledge.implementations.notion._NotionClient", _UnknownParentNotionClient)
...
async def test_notion_kb_aquery_error_returns_empty(monkeypatch, notion_kb):
    monkeypatch.setattr("starring.knowledge.implementations.notion._NotionClient", _FailingNotionClient)
