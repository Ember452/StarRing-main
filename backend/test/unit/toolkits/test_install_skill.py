...
from starring.agents.skills import service as skill_service
from starring.agents.toolkits.buildin import install_skill as exported_install_skill

install_skill_module = importlib.import_module("starring.agents.toolkits.buildin.install_skill")
...
def test_prepare_skill_invalid_virtual_path_does_not_fallback_to_sandbox(monkeypatch, tmp_path: Path):
    ...
    monkeypatch.setattr(
        "starring.agents.backends.sandbox.resolve_virtual_path",
        resolve_virtual_path,
    )
    monkeypatch.setattr(
        "starring.agents.backends.sandbox.ProvisionerSandboxBackend",
