...
from starring.knowledge.chunking.ragflow_like.parsers import semantic
from starring.models import select_embedding_model
...
def test_heading_inference():
    """测试标题层级推断工具类"""
    from starring.knowledge.chunking.ragflow_like.utils.md_parser_utils import infer_heading_level
