...
from starring.services.file_preview import MAX_BINARY_PREVIEW_SIZE_BYTES
...
async def test_read_office_pdf_preview_converts_and_caches_pdf(tmp_path, monkeypatch) -> None:
    ...
    monkeypatch.setattr("starring.storage.minio.get_minio_client", lambda: minio_client)
    monkeypatch.setattr("starring.knowledge.base.convert_office_to_pdf", fake_convert)
