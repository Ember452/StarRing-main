...
from starring.knowledge.eval import benchmark_generation
...
async def test_select_graph_enhanced_chunks_expands_by_ppr_with_anchor_bias(monkeypatch):
    ...
    monkeypatch.setattr(
        "starring.knowledge.graphs.milvus_graph_service.MilvusGraphService.query_and_rank_chunks_by_ppr",
        fake_rank,
    )
    chunks_by_id = {
