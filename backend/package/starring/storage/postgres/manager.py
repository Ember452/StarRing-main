...
from starring.storage.postgres.models_business import Base as BusinessBase
from starring.storage.postgres.models_knowledge import Base as KnowledgeBase
from starring.utils import logger
from starring.utils.singleton import SingletonMeta
...
class PostgresManager(metaclass=SingletonMeta):
    ...
    async def ensure_business_schema(self):
        ...
        stmts = [
            ...
            "ALTER TABLE IF EXISTS agent_runs ADD COLUMN IF NOT EXISTS output_payload JSONB",
