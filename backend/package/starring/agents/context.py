...
from starring.agents.backends.sandbox.paths import sandbox_workspace_agents_prompt_file
...
DEFAULT_STARRING_SUMMARY_PROMPT = """你是对话上下文压缩助手。
...
async def resolve_agent_resource_options(
    ...
    *,
    ...
    if "mcps" in fields_to_load:
        from starring.agents.mcp.service import get_all_mcp_servers
    ...
    if "skills" in fields_to_load:
        from starring.agents.skills.service import list_accessible_skills
...
async def prepare_agent_runtime_context(
    ...
    *,
    ...
    from starring.agents.middlewares.skills import resolve_runtime_skills_for_context
