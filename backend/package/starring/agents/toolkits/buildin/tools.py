...
from starring.agents.toolkits.registry import ToolExtraMetadata, _all_tool_instances, _extra_registry, tool
from starring.utils import logger
from starring.utils.paths import CONVERSATION_HISTORY_DIR_NAME, LARGE_TOOL_RESULTS_DIR_NAME, VIRTUAL_PATH_OUTPUTS
...
def _normalize_presented_artifact_path(filepath: str, runtime: ToolRuntime) -> str:
    from starring.agents.backends.sandbox.paths import (
        VIRTUAL_PATH_PREFIX,
        ensure_thread_dirs,
