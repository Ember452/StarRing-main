...
class StarRingSummarizationMiddleware(SummarizationMiddleware):
    """DeepAgents summarization middleware with starring-specific tool-call sanitization."""
...
def create_summary_middleware(
    ...
    *,
    ...
    """Create DeepAgents summarization middleware using starring's virtual outputs root."""
    middleware_kwargs = {
        "model": model,
