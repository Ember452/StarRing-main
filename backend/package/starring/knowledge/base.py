...
from starring.knowledge.chunking.ragflow_like.presets import ensure_chunk_defaults_in_additional_params
from starring.knowledge.schemas import FindOutputSchema, FindWindowSchema, SearchOutputSchema, SearchResultSchema
from starring.knowledge.utils import resolve_processing_params, sanitize_processing_params
from starring.services.file_preview import (
...
from starring.utils.datetime_utils import coerce_any_to_utc_datetime, utc_isoformat
...
class KnowledgeBase(ABC):
    ...
    async def add_file_record(
        ...
        """
        from starring.knowledge.utils.kb_utils import prepare_item_metadata
        ...
        if metadata.get("size") is None and content_type == "file":
            try:
                from starring.knowledge.utils.kb_utils import is_minio_url, parse_minio_url
                from starring.storage.minio import get_minio_client
    ...
    async def parse_file(self, kb_id: str, file_id: str, operator_id: str | None = None) -> dict:
        ...
        try:
            from starring.knowledge.parser.unified import Parser
    ...
    async def repair_missing_file_stats(self, kb_id: str) -> dict:
        ...
        from starring.repositories.knowledge_chunk_repository import KnowledgeChunkRepository
