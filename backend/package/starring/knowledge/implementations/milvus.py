...
from starring.knowledge.base import FileStatus, KnowledgeBase
from starring.knowledge.chunking.ragflow_like.dispatcher import chunk_markdown
...
from starring.knowledge.utils.kb_utils import resolve_processing_params
...
from starring.utils import hashstr, logger
...
class MilvusKB(KnowledgeBase):
    ...
    def __init__(self, work_dir: str, **kwargs):
        ...
        self.milvus_db = kwargs.get("milvus_db") or "starring"
