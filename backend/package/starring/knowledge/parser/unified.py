...
from starring.knowledge.parser.zip_utils import process_zip_file as _process_zip_file
...
def parse_pdf(file, params=None):
    ...
    from starring.knowledge.parser.base import DocumentProcessorException
...
async def _process_file_to_markdown_core(
    ...
    from starring.storage.minio.client import get_minio_client
