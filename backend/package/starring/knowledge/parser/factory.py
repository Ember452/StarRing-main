...
from starring.knowledge.parser.base import BaseDocumentProcessor
...
class DocumentProcessorFactory:
    ...
    PROCESSOR_TYPES = {
        "rapid_ocr": ("starring.knowledge.parser.rapid_ocr", "RapidOCRParser"),
        "mineru_ocr": ("starring.knowledge.parser.mineru", "MinerUParser"),
        "mineru_official": ("starring.knowledge.parser.mineru_official", "MinerUOfficialParser"),
        "pp_structure_v3_ocr": ("starring.knowledge.parser.pp_structure_v3", "PPStructureV3Parser"),
        "deepseek_ocr": ("starring.knowledge.parser.deepseek_ocr", "DeepSeekOCRParser"),
    }
