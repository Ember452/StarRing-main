...
from starring.knowledge.parser.base import BaseDocumentProcessor, DocumentParserException
from starring.knowledge.parser.zip_utils import process_zip_file_sync
