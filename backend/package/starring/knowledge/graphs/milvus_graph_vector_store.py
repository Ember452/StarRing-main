...
from starring.knowledge.graphs.graph_utils import graph_entity_collection_name, graph_triple_collection_name
from starring.knowledge.implementations.milvus import (
...
class MilvusGraphVectorStore:
    def __init__(self):
        ...
        self.milvus_db = os.getenv("MILVUS_DB") or "starring"
