...
from starring.agents.backends.sandbox.paths import _global_user_data_dir, ensure_workspace_default_files
...
from starring.services.mention_search_service import invalidate_workspace_mention_cache
...
from starring.utils.paths import VIRTUAL_PATH_WORKSPACE, WORKSPACE_DIR_NAME
from starring.utils.upload_utils import MAX_UPLOAD_SIZE_BYTES, write_upload_to_buffer
...
def _preview_binary_response(
    *, filename: str, content: bytes, media_type: str, preview_type: str
    ...
    headers = {
        ...
        "X-starring-Preview-Filename": quote(filename),
    }
