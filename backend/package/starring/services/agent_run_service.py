...
from starring.agents.models import resolve_chat_model_spec
...
from starring.storage.postgres.models_business import Message, User
...
def _compact_run_event_envelope(envelope: dict) -> dict | None:
    ...
    if event_type == "metadata":
        return None
    if event_type == "custom" and isinstance(payload, dict) and payload.get("name") == "starring.agent_state":
