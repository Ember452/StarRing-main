...
from starring.agents.backends import create_agent_composite_backend
from starring.agents.backends.sandbox import (
    SKILLS_PATH,
    USER_DATA_PATH,
    ensure_thread_dirs,
...
from starring.agents.backends.skills_backend import SelectedSkillsReadonlyBackend
from starring.agents.skills.service import normalize_string_list
from starring.services.agent_runtime_service import resolve_thread_agent_runtime_context
...
from starring.services.workspace_service import (
...
from starring.utils.datetime_utils import utc_isoformat_from_timestamp
from starring.utils.paths import VIRTUAL_PATH_OUTPUTS, VIRTUAL_PATH_UPLOADS, VIRTUAL_PATH_WORKSPACE
...
def _preview_binary_response(path: str, raw_content: bytes, preview_type: str) -> StreamingResponse:
    ...
    headers = {
        ...
        "X-starring-Preview-Type": preview_type,
        "X-starring-Preview-Filename": quote(file_name),
    }
