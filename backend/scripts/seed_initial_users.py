...
SUPERADMIN_UID = "solis"
SUPERADMIN_NAME = "solis"
SUPERADMIN_PHONE_NUMBER = "15251638888"
SUPERADMIN_PASSWORD = "solis123456"
DEFAULT_USER_PASSWORD = "starring123456"
...
async def seed_initial_users() -> None:
    ...
    from starring.storage.postgres.models_business import Department, User
...
def main() -> int:
    ...
    print("部门管理员和普通用户默认密码：starring123456")
    return 0
