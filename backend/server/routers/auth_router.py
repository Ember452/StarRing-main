...
from starring.storage.postgres.models_business import User, Department
from starring.repositories.user_repository import UserRepository
from starring.repositories.department_repository import DepartmentRepository
...
from starring.services.user_identity_service import generate_unique_uid, validate_username, is_valid_phone_number
from starring.services.operation_log_service import log_operation
from starring.services.auth_service import (
...
from starring.storage.minio import upload_image_to_minio
from starring.utils.datetime_utils import utc_now_naive

# OIDC 认证相关导入
from starring.services.oidc_service import (
