...
from starring.services.mention_search_service import search_mention_files_in_index
...
async def search_mention_files(
    ...
    if thread_id:
        ...
        if conversation:
            ...
            try:
                from starring.agents.backends.sandbox.paths import validate_thread_id
