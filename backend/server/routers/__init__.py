...
from server.routers.trigger_router import trigger_router
...
router.include_router(trigger_router)  # /api/triggers/* 触发器管理与 webhook 入口
router.include_router(workflow_router)  # /api/workflows/* 工作流管理与校验
